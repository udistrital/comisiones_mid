...
func init() {
	...
	beego.GlobalControllerRouter["github.com/udistrital/comisiones_mid/controllers:ObjectController"] = append(beego.GlobalControllerRouter["github.com/udistrital/comisiones_mid/controllers:ObjectController"],
